      ...
      <main className="mx-auto flex max-w-6xl flex-col gap-10">
        <section className="rounded-[2rem] bg-slate-950 px-8 py-10 text-white shadow-2xl shadow-slate-900/10 dark:bg-slate-900">
          <div className="max-w-3xl space-y-5">
            <p className="text-sm uppercase tracking-[0.35em] text-sky-300">Resume upload</p>
            <h1 className="text-4xl font-semibold tracking-tight sm:text-5xl">
              Upload your PDF resume for analysis.
            </h1>
            <p className="max-w-2xl text-base leading-8 text-slate-300">
              Use the upload form below to validate your PDF, extract text, store the resume, and receive immediate analysis feedback.
            </p>
          </div>
        </section>
